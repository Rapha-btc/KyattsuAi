;; Co-author: Rapha @jingcash | Pre-audit: Setzeus @strataLabs (prior to final version) | Post-audit: JJ @gecko_sec | Forked from: Friedger.btc
...
(define-constant ERR-OUT-OF-BOUNDS u4) 
...
(define-constant ERR_BTC_TX_ALREADY_USED (err u9)) ;; prevent double claiming
